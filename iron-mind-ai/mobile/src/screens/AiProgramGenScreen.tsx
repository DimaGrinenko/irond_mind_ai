    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        <View style={{ paddingHorizontal: 16, marginTop: 10 }}>
          <Card
            variant="secondary"
            style={{ padding: 14, borderColor: colors.amber, borderWidth: 1 }}
          >
            <View
            ...
            >
              {t('aiGen.intro', {
                goal: goalKey ?? t('aiGen.goalNone'),
                level: level ?? t('aiGen.levelNone'),
              })}
            </Text>
          </Card>
        </View>
        ...
        <View style={{ paddingHorizontal: 16, marginTop: 12 }}>
          <Card variant="secondary" style={{ padding: 14 }}>
            ...
            >
              {template.subtitle} · {t('aiGen.weeks', { n: template.weeks })} ·{' '}
              {t('aiGen.daysPerWeek', { n: template.daysPerWeek })}
            </Text>
